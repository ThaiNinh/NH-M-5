...
<div class="container-fluid">
	<header class="row py-2 px-5 justify-content-between">
		<div class="col d-sm-none d-lg-block">
			<a href="index.php" class="font-monospace font-weight-light " style="color:black; font-size:3rem; text-decoration: none; letter-spacing: 5px;">XU STORE</a>		
		</div>
					...
					<ul class="navbar-nav me-auto col-7">			  
					  ...
					  <li class="nav-item dropdown">
						...
						<div class="dropdown-menu rounded-0 m-0">
							...
							?>
							<a href="shop.php?loaisp_id=<?php echo $row['loaisp_id'];?>" class="dropdown-item"><?php echo $row['tenloaisp'];?></a>
							<?php } ?>
