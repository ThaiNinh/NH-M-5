...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 06, 2023 lúc 01:54 PM
...
(19, 'aa', '0395410715', 'aaaaaaa', 'nimtn88@gmail.com', '0b4e7a0e5fe84ad35fb5f95b9ceeac79', '2000-03-02', 1),
(20, 'a', '0395410715', 'aaaaaaa', 'nimtn88@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2000-03-02', 1);
...
--
ALTER TABLE `tbl_giaohang`
  MODIFY `giaohang_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_loaisp`
  MODIFY `loaisp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `tbl_nguoidung`
--
ALTER TABLE `tbl_nguoidung`
  MODIFY `nguoidung_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
