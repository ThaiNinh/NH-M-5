                        ...
                        <tbody>
                                    ...
                                    <tr class="rem1">
                                        <td class="invert"><?php echo $i ?></td>
                                            ...
                                            <td class="invert"><?php echo $row['tensp'] ?></td>
                                            <td class="invert"><?php echo number_format($row['dongia']).'vnd' ?></td>
                                            <td class="invert"><?php echo $row['size'] ?></td>
                                            <td class="invert" ><?php echo number_format($thanhtien).'vnd' ?></td>
                                        </td>
                                    </tr>
                                    <?php
                                        } 
                    ...
                    <div class="receiver-info">
                        <div class="billing-address">
                            ...
                            <div class="control-group">
                                ...
                                <input type="text" class="form-control" id="txtHovaten" name="txtHovaten" placeholder="Nhập tên"
                                required="required" data-validation-required-message="Please enter your name" />
                            
                            </div>
                            <div class="control-group">
                                <label for="sdt">Số điện thoại: </label>
                                <input type="text" class="form-control" id="txtSodienthoai" name="txtSodienthoai" placeholder="Số điện thoại"
                                required="required" data-validation-required-message="Please enter your name" />
                                
                            </div>
                            <div class="control-group">
                                <label for="diachi">Địa chỉ: </label>
                                <input type="text" class="form-control" id="txtDiachi" name="txtDiachi" placeholder="Số nhà - Phường/Xã - Quận/Huyện - Tỉnh/Thành phố"
                                required="required" data-validation-required-message="Please enter your name" />
                            ...
                            <div class="control-group">
                                ...
                                <?php
                                    ...
                                    <div class="ship-method"> 
                                        ...
                                        <div class="ship-content" id="<?php echo $row['giaohang_id'] ;?>">
                            ...
                            <div class="control-group">
                                <label for="ghichu">Ghi chú: </label><br>
                                    <textarea class="form-control" rows="4" id="txtGhichu" name="txtGhichu" placeholder="Ghi chú"
