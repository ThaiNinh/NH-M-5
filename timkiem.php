 ...
 <?php
	...
	<div class="row px-xl-5 pt-2 ">
		<?php
		while($row_tensp1 = mysqli_fetch_array($sql_product)){ 
		?>

				<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="./img/<?php echo $row_tensp1['sanpham_id']?>.jpg" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3"><?php echo $row_tensp1['tensp']?></h6>
                                
								<div class="d-flex justify-content-center">
                                <h6><?php echo $row_tensp1['dongia']?></h6>
								</div>
                        	</div>
                            <div class="card-footer d-flex justify-content-center bg-light border">
                            	<a href="./Detail_product.php?id=<?= $row_tensp1['sanpham_id']?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Xem chi tiết</a>                            </div>
                       	</div>
				</div> 	
        <?php }?>
	</div>
