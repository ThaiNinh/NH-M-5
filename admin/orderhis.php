...
<?php
    ...
    $sql="SELECT b.giohang_id, a.ten_nd,a.diachi, a.email, a.sdt
	FROM tbl_nguoidung as a, tbl_giohang as b
    WHERE  b.nguoidung_id=a.nguoidung_id and a.phanquyen=1 
    ORDER BY b.giohang_id ";
...
<table style="width: 100%" border="1" style="border-collapse: collapse;">
    ...
    <tr>
        <td><?php echo $i ?></td>
        <td name="giohang_id"><?php echo $row['giohang_id'] ?></td>
        <td><?php echo $row['ten_nd'] ?></td>
        <td><?php echo $row['diachi'] ?></td>
        <td><?php echo $row['email'] ?></td>
        <td><?php echo $row['sdt'] ?></td>
		<td>
			<a href="xemdonhang.php?giohang_id=<?php echo $row['giohang_id']?>"> Xem đơn hàng </a>
			<!--  echo $row['giohang_id'] -->
		</td>
