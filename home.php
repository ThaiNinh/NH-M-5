...
<head>
    ...
    <link rel = "stylesheet" type = "text/css" href="startbootstrap-creative-gh-pages/css/style.css" media="all">
	<script src="startbootstrap-creative-gh-pages/js/scripts.js"></script>
